...
export function HeroSection() {
  ...
  return (
    <section
      className="relative overflow-hidden pt-24 pb-8 md:pt-32 md:pb-12 bg-background min-h-screen flex items-start justify-center"
      style={{
    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-4 md:mb-6">
          <span className="inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/10 px-4 py-1.5 text-xs font-bold text-accent glow-green backdrop-blur-sm">
        ...
        <motion.h1
          ...
          className="mb-4 md:mb-6 font-headline text-4xl font-bold tracking-tight md:text-7xl lg:text-8xl leading-[1.1] text-white"
        >
        ...
        <motion.p
          variants={itemVariants}
          className="mb-6 md:mb-8 max-w-2xl text-base md:text-lg text-white/90 font-medium leading-relaxed"
        >
        ...
        <motion.div 
          variants={itemVariants}
          className="w-full relative py-3 md:py-4 bg-black/40 backdrop-blur-md border-y border-white/10 mb-8 md:mb-12 overflow-hidden flex"
        >
          <div className="flex animate-marquee whitespace-nowrap items-center shrink-0">
            {marqueeItems.map((text, i) => (
              <div key={`m1-${i}`} className="flex items-center gap-8 md:gap-12 px-4 md:px-6">
                <span className="text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] text-primary shrink-0">{text}</span>
        ...
        >
          <div className="flex flex-col items-center gap-0.5 group bg-black/40 p-3 md:p-4 rounded-xl backdrop-blur-sm border border-white/5 transition-all hover:border-accent/20">
            <div className="text-xl md:text-2xl font-bold text-white group-hover:text-accent transition-colors flex items-center">
              <NumberFlow value={stats.students} />
              <span>+</span>
            </div>
            <div className="text-[9px] md:text-[10px] text-white/80 uppercase tracking-widest font-bold flex items-center gap-1">
              <ShieldCheck className="w-3 h-3 text-accent" /> Students
            </div>
          </div>
          <div className="flex flex-col items-center gap-0.5 group bg-black/40 p-3 md:p-4 rounded-xl backdrop-blur-sm border border-white/5 transition-all hover:border-primary/20">
            <div className="text-xl md:text-2xl font-bold text-white group-hover:text-primary transition-colors flex items-center">
          ...
          <div className="flex flex-col items-center gap-0.5 group bg-black/40 p-3 md:p-4 rounded-xl backdrop-blur-sm border border-white/5 transition-all hover:border-destructive/20">
            <div className="text-xl md:text-2xl font-bold text-white group-hover:text-destructive transition-colors flex items-center">
